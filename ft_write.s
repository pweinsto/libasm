...
.error:
	mov	rcx, rax	; mov the error code that is in rax to rcx
	...
	add rsp, 8
	mov	[rax], rcx	; [] dreferenced the address in rax to get to the ___error function and give it the error code stored in r15. ___error funtion now sets the errno variable
